...
|---|--------|-------|----------|
| 1 | Add AC→Test mappings | WS under F032 | [00-032-29](../workstreams/backlog/00-032-29-ac-test-mappings.md) ✅ |
| 2 | Fix C901/E501 ruff violations | @issue → /bugfix | [Issue 003](../issues/003-f032-ruff-complexity.md) ✅ |
| 3 | Add tests for validators | WS under F032 | [00-032-30](../workstreams/backlog/00-032-30-validator-coverage.md) ✅ |
